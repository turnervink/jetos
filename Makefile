make:
	...
	arm-none-eabi-as src/common/graphics.s -o build/graphics.o
	...
	arm-none-eabi-ld build/boot.o build/graphics.o build/add.o build/hal.o build/kernel.o -T build/linker.ld -o build/kernel.elf
