make:
	...
	arm-none-eabi-as include/common/add.s -o build/add.o
	...
	arm-none-eabi-ld build/boot.o build/video_sample.o build/add.o build/hal.o build/kernel.o -T build/linker.ld -o build/kernel.elf
